...
if (isset($_GET['del']) && !FM_READONLY) {
    ...
    fm_redirect('files?p=' . urlencode(FM_PATH));
}
...
<head>
    ...
    <link rel="icon" href="/assets/imgs/theme/favicon.jpg">
    <link rel="shortcut icon" href="/assets/imgs/theme/favicon.jpg" type="image/jpeg">
...
<head>
    ...
    <title>File Manager</title>
    <meta name="Description" CONTENT="Web Storage">
    <link rel="icon" href="/assets/imgs/theme/favicon.jpg" type="image/png">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link rel="shortcut icon" href="/assets/imgs/theme/favicon.jpg">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
<nav class="navbar p-0 pl-2 navbar-light bg-light">
</nav>
<div id="wrapper">
